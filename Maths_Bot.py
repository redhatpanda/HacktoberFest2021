...
def rel_c():
    ...
    if noReturn == False and t > 0:
        if e == 1 and i == 0:
            ...
            print (
                "> You listen to its dream, but tell Math Bot that it's much better"
            ...
            i = 0
            print (
                "> You apologize for making fun of it. Math Bot accepts your"
        ...
        if c == 0 and i == 0:
            print (
                "> You thank Math Bot for solving that last problem for you."
            ...
            c = 2
            print (
                "> You tell Math Bot that it's very good at math. It still doesn't"
            ...
            c = 3
            print (
                "> You tell Math Bot that you appreciate all of its hard work."
            ...
            print (
                "> You continue to say nice things to Math Bot. It seems happy, but"
    ...
    # Reaction after being abused
        ...
        if c == 0:
            ...
            c = 1
            print (
                "> You try to apologize for all of the horrible things you did."
            ...
            c = 2
            print (
                "> You continue to apologize profusely, tears in your eyes. Math"
        ...
        # If you did hit - final apology
            ...
            c = 3
            print (
                "> You gently pick up Math Bot and do what you can to take out the"
        ...
        # If you didn't hit - final apology
            ...
            c = 3
            print (
                "> You tell Math Bot that you didn't mean what you said, and that"
...
def rel_i():
    ...
    if noReturn == False and talk == True and apology == False:
        if i == 0 and t < 3:
            i = 1
            print (
                "You tell Math Bot that you thought it was too dumb to actually"
        ...
        # Final insult before noReturn hits
            ...
            i = 2
            print (
                "> You continue to make fun of Math Bot and tell it that it's just a"
        ...
        # noReturn triggered, down to bad path
            ...
            hitMenu = True
            print (
                "> You loudly complain how long it takes Math Bot to do its job and"
        ...
        # To Neutral end
            ...
            print (
                "> You tell Math Bot that its art is awful, and it'll never be an"
        ...
        # Reply "no" to "Do you mean it?"
            ...
            i = 1
            print (
                "> You tell Math Bot that no, you didn't actually mean it and were"
    ...
    if noReturn == False and apology == False:
        if i == 0 and c == 0:
            i = 1
            print (
                "> You mutter that a calculator is easier to use than Math Bot."
                " Math Bot doesn't understand."
            )
        elif i == 1 and c == 0:
            i = 2
            print (
                "> You point out how little Math Bot can actually do. Math Bot blinks"
    ...
    # To bad path - fear on
        ...
        if i == 3:
            ...
            fear = True
            print (
                "> You shout at Math Bot. You tell it that you never should have bought"
            ...
            t = 0
            print (
                "> You continue shouting at Math Bot. You call it horrible, nasty"
            ...
            i = 6
            print (
                "> You scream at Math Bot as loud as you can. It tries to apologize,"
...
def rel_t():
    ...
    if noReturn == False:
        ...
        if i != 0:
            ...
            t = 1
            print (
                "> You ask Math Bot about itself. Math Bot is surprised, but"
            ...
            t = 2
            print (
                "> You ask Math Bot what it thinks of its job. Math Bot tells"
        ...
        # unlock "Encourage" here
            ...
            t = 3
            print (
                "> You ask Math Bot about its dream. Math Bot shyly tells you"
        ...
        # extra info from talking
            ...
            t = 4
            print (
                "> You ask Math Bot about why it wanted to become an artist."
        ...
        # talk loop
            ...
            print (
                "> Math Bot is waiting for you to say something. Will you"
    ...
    # after apologizing
        ...
        if t == 0:
            t = 1
            print (
                "> You ask Math Bot about itself. A little window flashes up"
            ...
            t = 2
            print (
                "> You ask Math Bot what it thinks about its job. Math Bot tells"
            ...
            t = 3
            print (
                "> You ask Math Bot about its dreams. It gives a vague response"
            ...
            print (
                "> Math Bot has gotten quiet. Maybe you should try encouraging"
                " it a little...?"
            )
...
def rel_e():
    ...
    if noReturn == False:
        if e == 0:
            e = 1
            print (
                "> You tell Math Bot that it has a wonderful dream, and should"
...
def rel_h():
    ...
    if apology == True:
        ...
        fear = True
        print (
            "> You smash the top of Math Bot as hard as you can with your fist,"
            " leaving a dent. Math Bot is stunned. It stares at you with wide eyes."
        )
    elif h == 1:
        h = 2
        print (
            "> You kick the side of Math Bot violently. It leaves a large dent."
            " It begins crying, begging you to stop."
        )
    elif h == 2:
        h = 3
        print (
            "> You pick up Math Bot and throw it at the wall with all of your"
...
def end(x):
    if x == 1:
        print (
            "> You say yes, you really mean it, and say that you think that the"
        ...
        print (
            "> A few months later, you see a news story about Math Bot on TV - its"
        ...
        print (
            "> Math Bot has decided that being an artist was a silly dream, and that"
        ...
        print (
            "> Math Bot can't take any more. It shuts itself down. No matter what"
        ...
        print (
            "> You try to be encouraging. Math Bot is furious and confused - why"
        ...
        print (
            "> You continue to hit Math Bot. Again. And again. And again. It isn't"
...
print (
    "> The instruction manual says - 'Thank you for your purchase!"
...
while power == False:
    ...
    if input == "walk away":
        ...
        print (
            "> You turn on the Math Bot on. The screen on the silver cube"
            " lights up, and two little glowing eyes stare back at you."
        )
        print (
            "> There is a menu underneath the little eyes."
